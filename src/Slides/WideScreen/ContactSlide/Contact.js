...
class Contact extends Component {
  ...
  handleScroll(event) {
    ...
    const minlimit = (documentElement.clientHeight * 620) / documentElement.scrollHeight;
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          ...
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/cristian-encalada" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:cris.encalada.camargo@gmail.com" />
          ...
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/cristian-encalada-45099616a/" />
        </SocialMediaIcons>
      </Container>
    );
  }
