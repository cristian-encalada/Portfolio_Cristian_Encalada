...
class Skills extends Component {
  ...
  handleScroll(event) {
    ...
    const minlimit = (documentElement.clientHeight * 580) / documentElement.scrollHeight;
    const maxlimit = (documentElement.clientHeight * 780) / documentElement.scrollHeight;
