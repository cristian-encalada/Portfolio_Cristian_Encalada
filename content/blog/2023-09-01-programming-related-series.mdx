...
<div className="flex justify-center">
  <div className="w-full max-w-screen-md overflow-hidden">
    <img
      src="/static/images/2023-09-01-programming-series/2023-09-01-mr_robot.webp"
      alt="Mr. Robot series"
      className="mx-auto"
    />
  </div>
...
<div className="flex justify-center">
  <div className="w-full max-w-screen-md overflow-hidden">
    <img
      src="/static/images/2023-09-01-programming-series/2023-09-01-the-big-bang-theory.webp"
...
<div className="flex justify-center">
  <div className="w-full max-w-screen-md overflow-hidden">
    <img
      src="/static/images/2023-09-01-programming-series/2023-09-01-the-it-crowd.webp"
...
<div className="flex justify-center">
  <div className="w-full max-w-screen-md overflow-hidden">
    <img
      src="/static/images/2023-09-01-programming-series/2023-09-01-black-mirror.webp"
