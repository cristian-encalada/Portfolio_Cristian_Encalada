...
**ECS:** Solo funciona con contenedores. Cuando se implementa un contenedor, aún tiene que ejecutarse en una máquina física o virtual, pero ECS no actúa como un servidor y no tiene ningún poder de servicio o cómputo.

**Clúster de ECS:** Es un conjunto de recursos (recursos subyacentes) en los que se ejecutarán los contenedores. Es la infraestructura física.
...
**Inicio de EC2:** Debemos gestionar las instancias de EC2 subyacentes (infraestructura). Debemos crear las instancias individuales de EC2.
...
**Inicio de ECS Fargate:** AWS gestiona la infraestructura subyacente (implementación sin servidor).
