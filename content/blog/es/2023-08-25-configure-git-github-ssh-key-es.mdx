...
También puedes notar una dirección de correo electrónico debajo de la opción **Mantener mis direcciones de correo electrónico privadas**, esta es tu dirección de correo electrónico privada de GitHub.
...
**Nota:** Los corchetes angulares (< >) en el fragmento de código a continuación indican que debes reemplazar esa parte del comando con la información adecuada. No incluyas los corchetes en el comando.

```sh
git config --global user.email "<#########+username@users.noreply.github.com>"
```

Recuerda usar **tu propia dirección de correo electrónico privada de GitHub**.
...
Ahora, necesitas decirle a GitHub cuál es tu clave SSH para que puedas subir tu código **sin escribir una contraseña cada vez**.
...
Ahora, después de cualquier cambio, **puedes subir tu código sin escribir una contraseña cada vez**.
