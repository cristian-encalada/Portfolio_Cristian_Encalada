...
En lugar de tener la vista predeterminada del perfil de Github, es posible generar una imagen animada del juego de "Snake" utilizando la herramienta [snk](https://github.com/marketplace/actions/generate-snake-game-from-github-contribution-grid) con **Github actions**.

En este tutorial hay muchas capturas de pantalla e instrucciones paso a paso durante todo el proceso. El objetivo es que **todos**, incluso con un conocimiento técnico básico, puedan intentar y actualizar el perfil personal de Github y al mismo tiempo aprender una introducción a los conceptos básicos de las herramientas de GitHub Actions.

El único **requisito previo** es tener una cuenta de **Github**.
...
> **dev-404-not-found/dev-404-not-found** es un repositorio ✨especial✨ que puedes utilizar para agregar un README.md a tu perfil de GitHub. Asegúrate de que sea público e inicialízalo con un README para comenzar.

El nuevo repositorio debería estar listo y tener la rama **main** de forma predeterminada.
...
- Click en **configura un workflow manualmente ->**
...
- Luego copia el siguiente código en el contenido de **Edit**:
...
- Click en el botón **Commit changes**, la opción **Commit directly to the main branch** debería estar seleccionada por defecto y luego haz click en **Commit changes** nuevamente.
...
- Haz click en el botón **Developer settings** en la parte inferior del menú izquierdo.
...
- Haz click en el botón **Generate token** en la parte inferior.
...
- Completa los primeros campos:
  ...
  - Haz click en **Agregar secreto** en la parte inferior
