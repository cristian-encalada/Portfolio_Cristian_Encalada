...
---
import underline-magical from '../../components/layouts/MDX/UsesLayout';

## Editor

<ul>
  <li>
    My editor of choice is <underline-magical href="https://code.visualstudio.com/">Visual Studio Code</underline-magical>   with a giant pile of
